...
const CurrentBAC = () => {
    ...
    function handleSetDrinksConsumed() {
        console.log("inside handleSetDrink", drinksConsumed);
        let array = [
            {
        ...
        console.log(array);
        setDrinksConsumed(array);
        console.log("inside handleSetDrink AFTER", drinksConsumed);
    }
