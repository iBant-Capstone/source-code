            ...
            <View style={{ backgroundColor: '#fff' }}>
                ...
                <View style={containerStyles.centerWhiteContainer}>
                    ...
                    <View style={containerStyles.row}>
                        ...
                        <Text style={textStyles.iconExplanationText}>This leads to our <Text style={textStyles.redSemiBoldText}>home page, the information hub,</Text> where you can find general information and common questions surrounding several alcohol consumption topics including drink types and safety measures.</Text>
                    </View>
                    <View style={containerStyles.row}>
