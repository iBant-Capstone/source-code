    ...
    return (
        <View style={containerStyles.centerWhiteContainer}>
            ...
            <View style={{ paddingHorizontal: 15 }}>
                <Text>Welcome to our app, <Text style={textStyles.redSemiBoldText}>BACtracker</Text>! This is a tool for young adults to explore and educate themselves about drinking alcohol.
