...
const LoginScreen3 = ({ navigation }) => {
    return (
        <View style={containerStyles.centerWhiteContainer}>
            ...
            <View style={containerStyles.horizontalPadding}>
                <Text>Our <Text style={textStyles.redSemiBoldText}>mission</Text> is to increase knowledge and understanding of safe alcohol consumption practices so you can be as informed as possible!</Text>
            </View>
