...
const LoginScreen4 = ({ navigation }) => {
    return (
        <View style={styles.centerContainer}>
            ...
            <Text>We want to protect the privacy of your information, so <Text style={styles.redBoldText}>all data is stored locally</Text>. If this app is deleted, your data will be lost.
